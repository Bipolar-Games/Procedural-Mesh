...
{
    [CreateAssetMenu(menuName = CreateAssetMenuPath.Root + "Drop Procedural Mesh")]
    public class DropProceduralMeshAsset : ProceduralMesh
    {
        [SerializeField]
        private Vector2Int resolution = new Vector2Int(8, 4);

        [SerializeField, Min(0)]
        private float radius = 1;
        [SerializeField, Min(0)]
        private float tipLength = 1;
